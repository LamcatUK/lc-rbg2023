...
function acf_blocks()
{
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            'name'                => 'lc_pdf_preview',
            'title'                => __('LC PDF Preview'),
            'category'            => 'layout',
            'icon'                => 'cover-image',
            'render_template'    => 'page-templates/blocks/lc_pdf_preview.php',
            'mode'    => 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
            'name'                => 'lc_jl_pushthrough',
            'title'                => __('LC JL Pushthrough'),
            'category'            => 'layout',
            'icon'                => 'cover-image',
            'render_template'    => 'page-templates/blocks/lc_jl_pushthrough.php',
            'mode'    => 'edit',
            'supports' => array('mode' => false),
        ));
    }
